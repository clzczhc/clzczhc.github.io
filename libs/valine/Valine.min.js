  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        if (l && c) {
          l(t, 'length').configurable && c(t, 'length', { value: 1 + u(0, e.length - (arguments.length - 1)) });
        }
        return t;
      };
      var f = function () {
...
*/
      !(function (n, a) {
        ...
        function n(e) {
          ...
          function o() {
            ...
            if (
              (i < n
                ? 'hidden' === o.overflowY && (t('scroll'), r(), (i = 'content-box' === o.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight))
                : 'hidden' !== o.overflowY && (t('hidden'), r(), (i = 'content-box' === o.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight)),
              c !== i)
            ) {
              c = i;
        ...
        (o.prototype.bind = function () {
                ...
                (v[t] = n),
                  n.on('input change blur propertychange', function (r) {
                    e.cfg.enableQQ &&
                      ...
                      'nick' === t &&
                      (isNaN(n.val())
                        ? S.default.store.get(h.QQCacheKey) && S.default.store.get(h.QQCacheKey).nick != n.val() && (S.default.store.remove(h.QQCacheKey), (E.nick = n.val()), (E.mail = ''), (E.QQAvatar = ''))
          ...
          var $ = function (t, n, r) {
              var o = (0, S.default)('<div class="vcard" id="' + t.id + '"></div>'),
                i = t.get('ua'),
                a = '';
              i && !/ja/.test(e.cfg.lang) && ((i = S.default.detect(i)), (a = i.os ? '<span class="vsys">' + i.browser + ' ' + i.version + '</span> <span class="vsys">' + i.os + ' ' + i.osVersion + '</span>' : '')),
            ...
            C = function (t, n) {
              t.on('click', function (r) {
                ...
                (0, S.default)('.vreply-wrapper[data-self-id="' + i + '"]')
                  ...
                  .find('.cancel-reply')
                  .show(),
                  (z = { at: S.default.escape(s) + ' ', rid: o, pid: i, rmail: n.get('mail') }),
              ...
              n.setACL(L()),
                n
                  ...
                  .then(function (t) {
                    ...
                    try {
                      z.rid
                        ? $(t, (0, S.default)('.vquote[data-self-id="' + z.rid + '"]'), !0)
                        : (Number(n.text())
            ...
            B = function t(n, r) {
              ...
              if (o > 0) {
                ...
                w(i[0], s),
                  D(a, function (l) {
                    500 != l.code
                      ? (i.val(i.val().replace(s, '![' + a.name + '](' + l.data.url + ')\r\n')), (0, c.default)(i[0]), ++r < o ? t(n, r) : M.removeAttr('disabled'))
                      : (i.val(i.val().replace(s, '')), (0, c.default)(i[0]), e.$el.find('.status-bar').text(l.msg).empty(3e3), M.removeAttr('disabled'));
                  });
              }
            },
            D = function (e, t) {
              var n = new FormData();
              n.append('image', e),
                S.default.ajax({ url: 'https://pic.alexhchu.com/api/upload', method: 'post', body: n }).then(function (e) {
                  e.json().then(t);
                });
            };
        }),
    ...
    function (e, t, n) {
      ...
      var r = n(3),
        ...
        i = function (e, t) {
          o.default.ajax({ url: 'https://app-router.com/2/route', body: { appId: e } }).then(function (e) {
    ...
    function (e, t, n) {
      ...
      var r = n(3),
        ...
        a = function (e, t) {
          ...
          n && n.qq == e
            ? t && t(n)
            : o.default.ajax({ url: '//valine.api.ioliu.cn/getqqinfo', method: 'POST', body: { qq: e } }).then(function (e) {
                e.json().then(function (e) {
        ...
        s = function (e) {
          o.default.ajax({ url: '//api.ip.sb/jsonip', method: 'jsonp' }).then(function (t) {
            e(t.ip);
          });
        };
    ...
    function (e, t, n) {
      ...
      t.default = function (e) {
        return (0, o.default)(e, {
          allowedAttributes: { a: ['title', 'href', 'name', 'target', 'rel'], img: ['alt', 'src', 'class', 'referrerpolicy'] },
          allowedClasses: {},
    ...
    function (e, t, n) {
      ...
      function c(e, t) {
        ...
        if (2 === n.length && i(e) && o(t)) for (var s = 0, u = e.length; s < u; s++) (a = t(e[s], f.get(e[s]))), c.set(e[s], a);
        return c;
      }
      t.__esModule = !0;
        ...
        a = {
          '[[DefaultValue]]': function (e) {
            ...
            if ((t = arguments.length > 1 ? arguments[1] : '[object Date]' === r.call(e) ? String : Number) === String || t === Number) {
              ...
              for (a = 0; a < s.length; ++a) if (i(e[s[a]]) && ((n = e[s[a]]()), o(n))) return n;
              throw new TypeError('No default value');
            }
    ...
    function (e, t, n) {
      'use strict';
      var r = {
        allowedAttributes: { a: ['href', 'name', 'target', 'title', 'aria-label'], iframe: ['allowfullscreen', 'frameborder', 'src'], img: ['src', 'alt', 'title', 'aria-label'] },
        allowedClasses: {},
        allowedSchemes: ['http', 'https', 'mailto'],
        allowedTags: [
          'a',
    ...
    function (e, t, n) {
      ...
      function r(e, t) {
        ...
        function f(e) {
          s.voids[e] || (!1 === h.ignoring ? (h = { ignoring: e, depth: 1 }) : h.ignoring === e && h.depth++);
        }
        function p(e) {
      ...
      !(function (t, n) {
        ...
        function b(e) {
          var t,
            ...
            r = '',
            o = e.length;
          for (t = 0; t < o; t++) (n = e.charCodeAt(t)), Math.random() > 0.5 && (n = 'x' + n.toString(16)), (r += '&#' + n + ';');
          return r;
        }
        function w(e, t, n) {
            ...
            return (
              ...
              (t.code = function (e, t) {
                ...
                if (n) {
                  ...
                  return { type: 'code', raw: n[0], codeBlockStyle: 'indented', text: this.options.pedantic ? o : N(o, '\n') };
                }
              }),
              (t.fences = function (e) {
              ...
              (t.nptable = function (e) {
                ...
                if (t) {
                  var n = { type: 'table', header: U(t[1].replace(/^ *| *\| *$/g, '')), align: t[2].replace(/^ *|\| *$/g, '').split(/ *\| */), cells: t[3] ? t[3].replace(/\n$/, '').split('\n') : [], raw: t[0] };
                ...
                if (t) {
                  ...
                  for (var m = 0; m < g; m++) {
                    ...
                    (r = n.length),
                      ...
                      s && (d.loose = !0),
                      this.options.gfm && ((l = /^\[[ xX]\] /.test(n)), (c = void 0), l && ((c = ' ' !== n[1]), (n = n.replace(/^\[[ xX]\] +/, '')))),
                      d.items.push({ type: 'list_item', raw: u, task: l, checked: c, loose: s, text: n });
                  }
                  return d;
                }
              }),
              (t.html = function (e) {
                ...
                if (t) return { type: this.options.sanitize ? 'paragraph' : 'html', raw: t[0], pre: !this.options.sanitizer && ('pre' === t[1] || 'script' === t[1] || 'style' === t[1]), text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(t[0]) : B(t[0])) : t[0] };
              }),
              (t.def = function (e) {
                var t = this.rules.block.def.exec(e);
                if (t) {
                  t[3] && (t[3] = t[3].substring(1, t[3].length - 1));
                  return { tag: t[1].toLowerCase().replace(/\s+/g, ' '), raw: t[0], href: t[2], title: t[3] };
                }
              }),
              (t.table = function (e) {
              ...
              (t.tag = function (e, t, n) {
                ...
                if (r)
                  return (
                    ...
                    { type: this.options.sanitize ? 'text' : 'html', raw: r[0], inLink: t, inRawBlock: n, text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(r[0]) : B(r[0])) : r[0] }
                  );
              }),
              (t.link = function (e) {
              ...
              (t.strong = function (e, t, n) {
                ...
                if (r && (!r[1] || (r[1] && ('' === n || this.rules.inline.punctuation.exec(n))))) {
                  ...
                  o.lastIndex = 0;
                  for (var i; null != (r = o.exec(t)); ) if ((i = this.rules.inline.strong.middle.exec(t.slice(0, r.index + 3)))) return { type: 'strong', raw: e.slice(0, i[0].length), text: e.slice(2, i[0].length - 2) };
                }
              }),
              (t.em = function (e, t, n) {
                void 0 === n && (n = '');
                ...
                if (r && (!r[1] || (r[1] && ('' === n || this.rules.inline.punctuation.exec(n))))) {
                  ...
                  o.lastIndex = 0;
                  for (var i; null != (r = o.exec(t)); ) if ((i = this.rules.inline.em.middle.exec(t.slice(0, r.index + 2)))) return { type: 'em', raw: e.slice(0, i[0].length), text: e.slice(1, i[0].length - 1) };
                }
              }),
              ...
              (t.autolink = function (e, t) {
                ...
                if (n) {
                  var r, o;
                  return '@' === n[2] ? ((r = B(this.options.mangle ? t(n[1]) : n[1])), (o = 'mailto:' + r)) : ((r = B(n[1])), (o = r)), { type: 'link', raw: n[0], text: r, href: o, tokens: [{ type: 'text', raw: r, text: r }] };
                }
              }),
              (t.url = function (e, t) {
                var n;
              ...
              (t.inlineText = function (e, t, n) {
                ...
                if (r) {
                  var o;
                  return (o = t ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(r[0]) : B(r[0])) : r[0]) : B(this.options.smartypants ? n(r[0]) : r[0])), { type: 'text', raw: r[0], text: o };
                }
              }),
              e
            );
                ...
                for (n = 0; n < x; n++)
                  switch (((f = e[n]), f.type)) {
                    ...
                    case 'blockquote':
                      ...
                      continue;
                    case 'list':
                      for (p = f.ordered, d = f.start, h = f.loose, i = f.items.length, u = '', r = 0; r < i; r++)
                        (g = f.items[r]),
                          (m = g.checked),
                          (y = g.task),
                          (v = ''),
                          g.task &&
                            ...
                            h
                              ? g.tokens.length > 0 && 'text' === g.tokens[0].type
                                ? ((g.tokens[0].text = b + ' ' + g.tokens[0].text), g.tokens[0].tokens && g.tokens[0].tokens.length > 0 && 'text' === g.tokens[0].tokens[0].type && (g.tokens[0].tokens[0].text = b + ' ' + g.tokens[0].tokens[0].text))
